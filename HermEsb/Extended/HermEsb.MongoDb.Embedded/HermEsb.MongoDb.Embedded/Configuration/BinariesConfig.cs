...
{
    [ConfigurationCollection(typeof(BinaryConfig), AddItemName = "binary", CollectionType = ConfigurationElementCollectionType.BasicMapAlternate)]
    public class BinariesConfig : ConfigurationElementCollection
    {
        ...
        {
        	return (ConfigurationElement)ContextManager.Instance.CurrentContext.Resolve<IBinaryConfig>();
        }
        ...
        {
            return ((BinaryConfig) element).Name;
        }
        ...
        public BinaryConfig this[int index]
        {
            get { return (BinaryConfig)BaseGet(index); }
            set
            {
        ...
        /// <exception cref="T:System.Configuration.ConfigurationErrorsException">
        ///   <paramref name="prop"/> es de sólo lectura o se bloquea.</exception>
        new public BinaryConfig this[string name]
        {
            get { return (BinaryConfig)BaseGet(name); }
        }
        #endregion
    }
}